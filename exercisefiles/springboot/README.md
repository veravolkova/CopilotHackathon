...
There is already a unit test implemented for this exercise, navigate to **springboot/copilot-demo folder** in the terminal and run the test using the command `mvn test` before and after to validate that the code generated by Copilot is correct.
